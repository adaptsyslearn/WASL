...
plot \
'singleApp.csv' u ($0-0.2): ($3/$2) w boxes ls 2 fs pattern 4 title "Uncoordinated",\
	''      u ($0):($4/$2):xticlabel(1) w boxes ls 1 fs pattern 1 title "WASL",\
         ''     u ($0+0.2):($2/$2) w boxes ls 8 fs pattern 2 title "Monolithic"
      

#Normalized by column $2 
