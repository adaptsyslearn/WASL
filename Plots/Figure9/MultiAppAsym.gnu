...
set xlabel "Multiple Applications (Asymmetric)" offset 0.5, -1
#set yrange [-0.15:3]
...
plot \
'MultiAppAsym.csv' u ($0-0.15):($3/$2) w boxes ls 2 fs pattern 4 title "Uncoordinated", \
