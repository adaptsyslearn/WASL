...
set xlabel "Multiple Applications (PI Module)" offset 0.5, -1
set yrange [-0.15:37]
...
plot \
'MultiAppPI.csv' u ($0-0.15):($3/$2) w boxes ls 2 fs pattern 4 title "Uncoordinated", \
