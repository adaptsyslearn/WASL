...
plot 'stability.csv' u ($0-0.2):($7) w boxes ls 2 fs pattern 4 title "Uncoordinated", \
	''      u ($0):($8):xticlabel(1) w boxes ls 1 fs pattern 1 title "WASL", \
