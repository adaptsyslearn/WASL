...
plot 'stability.csv' u ($0-0.2):($5) w boxes ls 2 fs pattern 4 title "Uncoordinated", \
	''      u ($0):($6):xticlabel(1) w boxes ls 1 fs pattern 1 title "WASL", \
